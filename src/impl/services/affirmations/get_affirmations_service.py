    ...
    def _process_request(self):
        ...
        for affirmation in self.affirmations:
            affirmation_response = AffirmationModel(
                ...
                source=affirmation.source or "user_created",  # Use source from DB or default
                playing_voice=affirmation.voice_id,
                is_scheduled=affirmation.schedule_config is not None,
                schedule_config=affirmation.schedule_config,  # Now loaded directly from JSON column
