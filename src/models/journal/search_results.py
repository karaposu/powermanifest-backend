...
class SearchResult(BaseModel):
    ...
    content: Optional[StrictStr] = Field(default=None, description="Content with highlighted matches")
    ...
    relevanceScore: Optional[float] = Field(default=None, description="Search relevance score", alias="relevanceScore")
    __properties: ClassVar[List[str]] = ["id", "content", "mood", "timestamp", "relevanceScore"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if relevanceScore (nullable) is None
        # and model_fields_set contains the field
        if self.relevanceScore is None and "relevanceScore" in self.model_fields_set:
            _dict['relevanceScore'] = None
...
class SearchResults(BaseModel):
    ...
    SearchResults
    """  # noqa: E501
    results: Optional[List[SearchResult]] = Field(default=None, description="Search results")
