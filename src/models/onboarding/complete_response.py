...
class CompleteResponse(BaseModel):
    ...
    CompleteResponse
    """  # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Whether onboarding completion was successful")
    message: Optional[StrictStr] = Field(default=None, description="Completion message")
